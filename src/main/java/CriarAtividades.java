 ...
 * @author rycha
 */
public class CriarAtividades extends javax.swing.JFrame {

    /**
     * Creates new form CriarAtividades
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CriarAtividades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CriarAtividades().setVisible(true);
            }
        });
    }
